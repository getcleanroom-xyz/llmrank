  ...
  return (
    <div className="page" style={{ display: "flex", flexDirection: "column" }}>
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "var(--gap) var(--page-px)", width: "100%" }}>
        {/* Query hero card */}
        <div style={{ position: "relative", background: "#FFF9DB", border: "2px solid var(--border)", borderRadius: "var(--radius)", boxShadow: "4px 4px 0 #1A1A1A, -1px 2px 0 #1A1A1A", padding: "24px 28px", marginBottom: "var(--gap)", transform: "rotate(-0.2deg)" }}>
