...
# 1 credit = $0.001. Costs based on real scan prompts (~215 input / ~130 output tokens).
# Prices verified against OpenRouter /api/v1/models as of 2026-07-11.
CREDIT_COSTS: dict[str, int] = {
    "chatgpt": 1,        # GPT-4o Mini:         $0.15/$0.60  per 1M  → ~$0.0001/request
    "gpt4o": 2,          # GPT-4o:              $2.50/$10.00 per 1M  → ~$0.002/request
    "gemini": 1,         # Gemini 3 Flash:      $0.50/$3.00  per 1M  → ~$0.0005/request
    "llama": 1,          # Llama 3.3 70B:       $0.10/$0.32  per 1M  → ~$0.0001/request
    "llama-small": 1,    # Llama 3.1 8B:        $0.02/$0.03  per 1M  → ~$0.00001/request
    "claude": 3,         # Claude Sonnet 4.5:   $3.00/$15.00 per 1M  → ~$0.003/request
    "deepseek": 1,       # DeepSeek Chat V3:    $0.20/$0.80  per 1M  → ~$0.0001/request
    "deepseek-r1": 1,    # DeepSeek R1:         $0.70/$2.50  per 1M  → ~$0.0005/request
